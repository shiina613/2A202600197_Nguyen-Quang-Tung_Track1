# Day 26 — 2A202600197 Nguyễn Quang Tùng
...
<!-- Nội dung hướng dẫn gốc của giảng viên (giữ lại để tham khảo) -->
...
Kho mẫu của giảng viên: [https://github.com/VinUni-AI20k/Day26-Track01-AI-Product-Strategy](https://github.com/VinUni-AI20k/Day26-Track01-AI-Product-Strategy)
...
```text
Day26-MãHọcViên/                                ← kho GitHub công khai (1 kho/người)
│
├── README.md                                   ← Mã học viên + tên + link deliverable
│
└── worksheet/
    │
    ├── 01-bigtech-disruption/                  🎯 LAB 1 — cá nhân
    │   ├── 1-research.md                       ← Trung gian: chọn case + tự nghiên cứu số liệu
    │   ├── 2-analysis.md                       ← Trung gian: trả lời 4 câu hỏi + 5 chiều định lượng
    │   └── 3-FINAL-case-analysis.md            🎯 KẾT QUẢ CUỐI Lab 1
    │
    ├── 02-product-comparison/                  🎯 LAB 2 — nhóm (freestyle file format)
    │   ├── analysis-report.pdf                 🎯 BẮT BUỘC — slide deck nhóm đã xuất PDF
    │   ├── analysis-report-link.md             📎 Tuỳ chọn — link Google Slides công khai
    │   ├── group-members.md                    📌 BẮT BUỘC — 2 thành viên + nhiệm vụ chung
    │   └── [freestyle]                         📂 screenshots/, research notes...
    │
    └── 03-takenotes.md                         🎯 LAB 3 — cá nhân (quan sát nhóm khác)
```
...
1. **Đọc lại nội dung** Lens 1-4 + Spark/Loop/System từ lecture
2. **Lab 1** — Tìm 1 case bị ảnh hưởng bởi big tech AI (cá nhân — 40 phút)
   - Phase 1: Chọn case + tự nghiên cứu số liệu (15')
   - Phase 2: Trả lời 4 câu hỏi (15')
   - Phase 3: Viết bài phân tích cuối (10')
3. **Lab 2** — Phân tích 2 sản phẩm AI (nhóm — 40 phút)
...
**File cuối của Lab 1:** `worksheet/01-bigtech-disruption/3-FINAL-case-analysis.md`
...
**Yêu cầu:** mỗi số liệu phải có nguồn (URL + tên báo/tổ chức + ngày tháng).
**Quy tắc:** không có số liệu = không có nhận định.

**File dùng ở phase này:** `worksheet/01-bigtech-disruption/1-research.md`
...
**File dùng ở phase này:** `worksheet/01-bigtech-disruption/2-analysis.md`
...
**File cuối:** `worksheet/01-bigtech-disruption/3-FINAL-case-analysis.md`
...
- `worksheet/02-product-comparison/group-members.md` (bắt buộc — 2 thành viên)
- `worksheet/02-product-comparison/analysis-report-link.md` (tuỳ chọn — link slides)
...
**File cuối của Lab 3:** `worksheet/03-takenotes.md`
...
| --- | --- |
| `glossary.md` | Bảng tra 19 thuật ngữ tiếng Anh + slide tham chiếu |
...
- [ ] `01-bigtech-disruption/3-FINAL-case-analysis.md` có cấu trúc 10 phần (đã bổ sung Phần 5 — Phân tích định lượng 5 chiều). Tổng cộng ≥ 12 bằng chứng / nguồn trong file FINAL (Phần B yêu cầu thêm số liệu định lượng).
...
| Đặt tên ảnh tuỳ ý (vd: Screenshot...) | Theo quy tắc `product-A-1-entry.png` |
